...
const Message = () => {
    return (
        <>
            <div className={"dark"}>
                <div className="py-8 px-8 max-w-sm mx-auto bg-white dark:bg-gray-500 rounded-xl shadow-md space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
                    <img className="block mx-auto h-24 rounded-full sm:mx-0 sm:flex-shrink-0" src="https://v2.tailwindcss.com/img/erin-lindford.jpg" alt="Woman's Face"/>
